...
@NgModule({
  imports: [
  CommonModule,Feature1Module,Feature2RoutingModule  // since we have imported featured module1 we can access share module component in this feature2 module component
  ],
